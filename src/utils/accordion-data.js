export const accordionData = [
  { 
    ...
    description: `
        ...
        The simplest way to understand a POS system is to think of it as a more modern cash register that can do so much more than just ring up customers.
        ...
        - **Tablet or computer**—This is the device where your POS software is installed or accessed so your laptop can be used as a POS system. It’s where you and your staff will interact with your POS day-to-day. Most modern POS systems run on iPads or Android tablets. However, some will also run from desktop computers.
        - **Card terminal**—This piece of hardware is how you take payments with your POS. It allows you to accept electronic payments like credit and debit cards, as well as mobile payments like Apple Pay and Google Pay.
        - **Cash drawer**—This is a part of your POS cash register set up, allowing you to store cash, receipts, and other important documents during shifts. A cash register is not a POS system in and of itself, but rather a crucial component.
        ...
        - **Selling online**—You need a POS system for online business. Today’s modern POS software often includes or integrates with an ecommerce platform, allowing you to sell online, while also syncing inventory and other data with your POS.
  ...
  {
    title: "What is the best POS system for a small business?",
    description: `Selecting the best POS system for your small business can be a difficult choice—the only thing you know for sure is that yes, you do need a POS system for your business. There are many POS vendors, with each offering an overlapping feature set. So, how does a business owner go about identifying the best POS system for small business?
...
Analytics—Determine your best selling dishes, track employee performance and identify your peak hours to understand your business and run it more effectively.`,
  },
  {
    ...
    description: `A point of sale system is used to track and manage your inventory and ring up sales. A payment processor handles the actual transaction during sales.
...
A point of sale system facilitates the transaction in question—if a payment processor connects to your bank, your POS system powers your till. POS systems like Lightspeed can integrate with payment processors to automatically transit information between your inventory system and card reader. In addition, Lightspeed includes tools for inventory management, CRM and data analysis, and we have even developed our own payment processing system: Lightspeed Payments.`,
  ...
  {
    title: "Does a POS system need Internet?",
    description: `Generally, yes, a cloud-based POS system needs the internet at least some of the time for various functions, such as processing credit card transactions, updating inventory in real time and syncing sales data to other systems for analytics and reporting.

        An internet-connected POS system is generally a better choice than a server-based POS, because it offers more reliability in transaction handling, allows for seamless updates and integrations with other cloud-based services and provides access to real-time data from any location without extra costs of hosting your servers yourself.`,
  },
  {
    title: "Why does a business need a POS system?",
    description: `Lightspeed Payments users receive one free payments terminal to use in their retail store. No other plans include hardware. Lightspeed Payments is currently only available for Lightspeed Retail users in the US.
  ...
  {
    title: "Is hardware included in the point of sale subscription?",
    description: `Lightspeed Payments is now included in all POS system subscription options for Lightspeed Retail users in the US and Canada. However, you are not required to use Lightspeed Payments as your payments processor. Credit card processing rates through Lightspeed Payments are set at a predictable fee for all card types, including American Express: 2.6% + $0.10 per transaction (2.9% + $0.30 card-not-present).
  ...
  {
    title: "What kind of support do you offer for your POS system?",
    description: `All new Lightspeed users are entitled to a free one-on-one onboarding session. A product expert will walk you through the POS system's major features and answer any and all of your business questions relevant to your business. After you've completed your onboarding session, we offer free phone support, available 24/7 in English.
  ...
  {
    title: "Do I have to use your credit card processor with the POS system?",
    description:
      "Lightspeed Payments is now included in all POS system subscription options for Lightspeed Retail users in the US and Canada. Credit card processing rates through Lightspeed Payments are set at a predictable fee for all card types, including American Express: 2.6% + $0.10 per transaction (2.9% + $0.30 card-not-present).",
  },
];
