...
const PosSystem = () => {
  ...
  <section className="flex items-center flex-wrap flex-col sm:flex-row justify-between w-full pt-20 sm:pt-24 pb-10 bg-3">
      <div className=" text-center sm:text-left p-2 md:pl-24 w-full md:w-3/5 h-[540px] sm:h-[440px] flex flex-col justify-around sm:justify-around gap-3 md:gap-0 px-7 sm:px-10">
