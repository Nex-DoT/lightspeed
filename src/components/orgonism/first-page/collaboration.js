...
const Collaboration = () => {
  return (
    <section className=" bg-2 w-full flex flex-col items-center justify-center gap-10 pt-14 p-7">
      <h1 className="text-2xl md:text-4xl font-semibold text-center px-4">Powering the best businesses in Quebec</h1>
